...
| BW-49 | Medium | LIVE | Only `egress_outside_allowlist` drives the scored verdict; the other 12 `security_runtime` dispositions are captured but never gate — `doctor` now names them (disclosure) |
