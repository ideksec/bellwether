...
walked out of, and a §24 violation whose text reaches the byte-compared report. **`harness_state_write` (§3.5/§10.2) was attempted and withdrawn**: the gate
