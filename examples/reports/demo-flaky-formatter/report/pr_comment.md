...
_failed one or more blocking gates._ · profile **medium** · skill **flaky-formatter** (`medium` criticality)
...
**Gates:** 🔴 1 block · 🟡 1 warn · ⚪ 5 not_evaluable · 🟢 3 pass
...
| security_runtime.sensitive_directories | ⚪ `not_evaluable` | unobserved | warn | api-loop-scripted-frontier: Plane A's coverage cannot support an absence claim for every run in this set, so 'no sensitive directory was touched' is not an earned absence (§10.7, §10.8) |
...
| budget.wall_clock | 🟢 `pass` | 20.00 min | ≤ 60 min | matrix: the matrix spent 20.00 min of wall clock, within the 60 min ceiling |
